# Student Identity
LAST_NAME = "Julian"          # Replace with your actual surname if different
STUDENT_ID = "TUPM-26-1916"   # REPLACE THIS with your actual student ID number
...
for key, value in sys_config.items():print(f"{key.upper()}: {value}")
